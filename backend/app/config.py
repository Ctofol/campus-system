...
FACE_LOCAL_MIN_SIMILARITY = float(os.getenv("FACE_LOCAL_MIN_SIMILARITY", "0.55"))
FACE_LOCAL_MIN_FACE_RATIO = float(os.getenv("FACE_LOCAL_MIN_FACE_RATIO", "0.035"))
FACE_LOCAL_MIN_BRIGHTNESS = float(os.getenv("FACE_LOCAL_MIN_BRIGHTNESS", "45"))
FACE_LOCAL_MIN_SHARPNESS = float(os.getenv("FACE_LOCAL_MIN_SHARPNESS", "35"))
