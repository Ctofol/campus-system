...
(() => {
  ...
  var _sfc_main = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const tabList = (0, import_vue2.computed)(() => {
...
\u7528\u65F6\uFF1A${formatTime(duration.value)}`,
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("scroll-view", {
      ...
      (0, import_vue2.createElementVNode)("view", { class: "test-page-root" }, [
        ...
        (0, import_vue2.createElementVNode)("view", { class: "tab-bar" }, [
          (0, import_vue2.createElementVNode)("view", { class: "tab-bar-border" }),
          ((0, import_vue2.openBlock)(true), (0, import_vue2.createElementBlock)(
            import_vue2.Fragment,
            null,
            (0, import_vue2.renderList)($setup.tabList, (item, index) => {
              return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
                ...
                (0, import_vue2.createElementVNode)(
                  ...
                  {
                    class: "tab-text",
                    style: (0, import_vue2.normalizeStyle)({ color: $setup.currentTab === item.pagePath ? "#20C997" : "#666666" })
                  },
